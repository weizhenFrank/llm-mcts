...
from vh.vh_mdp.vh_graph.envs.utils import Graph, Task, Predicate

from vh.vh_sim.simulation.evolving_graph.utils import load_graph_dict, load_name_equivalence, graph_dict_helper
...
class VhGraphEnv(gym.Env):
    ...
    def _mask_state(self, state, char_index):
        ...
        observable_object_ids = [object_id for object_id in object_in_room_ids if not object_hidden(object_id)] + self.rooms_ids + [character_id]
